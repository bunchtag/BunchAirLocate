...
Приложение предназначено для демонстрации работы с Bunch Beacon. Приложение полностью основано на, уже ставшем стандартным примере
работы с iBeacon, AirLocate. В код добавлены соответствующие методы по работе с Bunch Beacon. Там где это возможно, вызовы соседствуют с 
вызовами стандартных методов для работы с iBeacon встроенных в iOS. Общий принцип работы с Bunch Beacon очень похож на работу с встроенными в iOS
методами, что хорошо видно из примера.


Ниже приведен стандартный readme от проекта AirLocate
